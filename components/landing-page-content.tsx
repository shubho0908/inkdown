  ...
  return (
    <main id="content">
      ...
      <AnimatedSection
        ...
        className="relative mt-24 overflow-hidden rounded-3xl border"
      >
        <AuroraBars className="absolute inset-0 -z-10" />
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-24 text-center sm:px-6 sm:py-28 lg:px-8 lg:py-28">
