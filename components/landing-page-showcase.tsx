    ...
    visual: (
      <div className="flex h-full w-full flex-col backdrop-blur-3xl relative">
        <div className="flex items-center gap-2 border-b border-border bg-muted/30 px-4 py-2.5 sm:py-3">
          ...
          <div className="sm:ml-4 text-xs font-medium text-muted-foreground">
            brand_guidelines.md
          </div>
        </div>
        <div className="flex flex-col sm:flex-row flex-1 p-0 overflow-hidden">
          <div className="w-full sm:w-1/2 sm:border-r border-b sm:border-b-0 border-border bg-muted/10 p-4 sm:p-6 text-[12px] sm:text-[13px] font-mono text-muted-foreground overflow-y-auto hide-scrollbar">
            ...
            <m.div
              ...
              className="mt-4 leading-relaxed whitespace-pre-wrap text-foreground/80"
            >
            ...
            <m.div
              ...
              className="mt-4 leading-relaxed whitespace-pre-wrap pl-3 border-l-2 border-muted-foreground/30 text-foreground/60 italic"
            >
            ...
            <m.div
              ...
              className="mt-2 leading-relaxed whitespace-pre-wrap text-foreground/50"
            >
              - **Heading:** Outfit, sans-serif
              <br />- **Body:** Inter, dynamic weight
            </m.div>
          </div>
          <div className="w-full sm:w-1/2 p-4 sm:p-6 text-xs sm:text-[14px] font-sans text-foreground bg-background/40 overflow-y-auto hide-scrollbar">
            <m.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2 }}
              className="text-lg sm:text-2xl font-display font-semibold tracking-tight truncate"
            >
              Brand Guidelines
            </m.div>
            <m.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3 }}
              className="mt-3 sm:mt-4 leading-relaxed text-foreground/80 break-words"
            >
              Overview of our core aesthetic.
            </m.div>
            <m.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.4 }}
              className="mt-4 pl-4 border-l-2 border-muted/30 py-1 text-muted-foreground italic tracking-wide"
            >
              &quot;Design is how it works.&quot;
            </m.div>
            <m.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="mt-6 text-sm sm:text-lg font-display font-medium tracking-tight truncate border-b border-border/50 pb-1"
            >
              Typography Primary
            </m.div>
            <m.ul
              ...
              className="mt-3 text-foreground/80 list-disc list-inside space-y-1.5 ml-1"
            >
              <li>
                <strong>Heading:</strong> Outfit, sans-serif
              </li>
              <li>
                <strong>Body:</strong> Inter, dynamic weight
              </li>
            </m.ul>
          </div>
        </div>
      ...
      <div className="flex h-full w-full flex-col backdrop-blur-3xl relative">
        ...
        <div className="flex flex-1 flex-col p-4 gap-1.5 overflow-y-auto hide-scrollbar">
          <m.div
            ...
            transition={{ delay: 0.1 }}
            className="flex items-center justify-between rounded-lg bg-muted/50 py-2.5 px-3 border border-border/50 shadow-sm"
          >
          ...
          <div className="pl-6 flex flex-col gap-1 border-l border-border/50 ml-3 py-1">
            <m.div
              ...
              className="flex items-center gap-3 rounded-md py-1.5 px-2 hover:bg-muted/50 transition-colors cursor-pointer"
            >
            ...
            <m.div
              ...
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.2 }}
              className="flex items-center gap-3 rounded-md py-1.5 px-2 bg-background border border-border shadow-sm cursor-pointer"
            >
          ...
          <m.div
            ...
            animate={{ x: 0, opacity: 1 }}
            transition={{ delay: 0.3 }}
            className="mt-2 flex items-center justify-between rounded-lg hover:bg-muted/30 transition-colors py-2 px-3 border border-transparent"
          >
            <div className="flex items-center gap-3">
            ...
            <div className="text-[10px] text-muted-foreground px-2 py-0.5 rounded-full border border-border bg-muted">
              2
            </div>
          </m.div>
          ...
          <m.div
            ...
            className="mt-1 flex items-center justify-between rounded-lg hover:bg-muted/30 transition-colors py-2 px-3 border border-transparent"
          >
            <div className="flex items-center gap-3">
      ...
      <div className="flex h-full w-full items-center justify-center p-4 sm:p-8 backdrop-blur-3xl relative">
        ...
        >
          ...
          <div className="text-center">
            <h3 className="font-display font-medium tracking-tight text-foreground text-lg sm:text-xl">
              Shared Successfully
            </h3>
          ...
          <div className="mt-1 sm:mt-2 flex w-full items-center gap-2 sm:gap-3 rounded-lg border border-border bg-muted/30 p-1.5 pl-3 sm:pl-4 transition-colors hover:bg-muted/50">
            <span className="truncate flex-1 text-xs text-muted-foreground font-mono">
              inkdown.app/d/xyz
            </span>
            ...
            {scenarios.map((scenario, idx) => (
              ...
              >
                <div className="flex items-center gap-4 w-full">
                  <div
                    className={`flex size-11 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-xl border transition-colors ${
                      activeIndex === idx
                        ? "border-transparent bg-foreground text-background shadow-inner"
                  ...
                  <h3
                    className={`font-display text-lg sm:text-xl font-medium tracking-tight transition-colors ${activeIndex === idx ? "text-foreground" : "text-foreground/60 group-hover:text-foreground/80"}`}
                  >
                    {scenario.title}
                  </h3>
                </div>
