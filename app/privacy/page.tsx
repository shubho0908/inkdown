...
export const metadata: Metadata = {
  ...
  description:
    "How Inkdown collects, uses, and protects your personal information.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none break-words space-y-8 text-sm leading-7 sm:text-base">
            <section>
              ...
              <p>
                Inkdown (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;)
                is committed to protecting your privacy. This Privacy Policy
                explains how we collect, use, disclose, and safeguard your
                information when you use our markdown editor and document
                sharing platform, including our website, web application, and
            ...
            <section>
              ...
              <p>
                ...
                email address and password. We use email for account management,
                notifications, and communication purposes.
              </p>
              ...
              <p>
                We store and process the markdown documents, files, and folders
                you create within Inkdown. This content is encrypted and stored
                securely on our servers. You retain all ownership and rights to
                your content.
              </p>
              ...
              <p>
                ...
                with the Service, including device information, IP address,
                browser type, referring pages, and pages visited. This data
                helps us improve our Service and understand user behavior
                patterns.
              </p>
              ...
              <p>
                ...
                user experience, remember your preferences, and analyze website
                traffic. You can control cookie settings through your browser
                preferences.
              </p>

              <h3 className="mt-4 text-lg font-semibold">
                2.5 Shared Document Metadata
              </h3>
              <p>
                When you make a document public and share it, we maintain
                metadata about the shared link including creation date, access
                count, and document title for analytics and abuse prevention
                purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="ml-2 list-inside list-disc space-y-2">
                ...
                <li>
                  Sending periodic emails regarding your account or Service
                  updates
                </li>
                <li>
                ...
                <li>
                  Monitoring and analyzing trends, usage, and activities for
            ...
            <section>
              ...
              <p>
                Your documents are encrypted in transit and at rest. Your
                password is hashed using industry-standard encryption. Access to
                personal information is restricted to employees who need it to
            ...
            <section>
              ...
              <p>
                ...
                delete your personal information and documents within 30 days,
                except where we are required to retain data for legal or
                compliance purposes.
              </p>
              <p>
                Shared public documents may remain accessible via their unique
                links even if you delete your account, unless you explicitly
                revoke sharing before deletion.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Inkdown uses third-party service providers including Supabase
                for database services and analytics platforms. These providers
                have their own privacy policies and we encourage you to review
                them. We do not share personal information with third parties
            ...
            <section>
              ...
              <p>
                Inkdown is not intended for children under 13 years of age. We
