...
const privacySocialImages = createSocialImageSet("/", "Inkdown privacy policy preview");
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/privacy",
    siteName: "Inkdown",
    images: privacySocialImages.openGraph,
  },
  twitter: {
    card: "summary_large_image",
    title: "Privacy Policy",
    description: "How Inkdown collects, uses, and protects your personal information.",
    images: privacySocialImages.twitter,
  },
};
        ...
        <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
          ...
          <article className="prose prose-neutral dark:prose-invert max-w-none break-words space-y-8 text-sm leading-7 sm:text-base">
            <section>
              ...
              <p>
                Inkdown (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to
                protecting your privacy. This Privacy Policy explains how we collect, use, disclose,
                and safeguard your information when you use our markdown editor and document sharing
                platform, including our website, web application, and related services
            ...
            <section>
              ...
              <p>
                When you create an account, we collect information such as your email address and
                password. We use email for account management, notifications, and communication
                purposes.
              </p>

              <h3 className="mt-4 text-lg font-semibold">2.2 Document and Content Data</h3>
              <p>
                We store and process the markdown documents, files, and folders you create within
                Inkdown. This content is encrypted and stored securely on our servers. You retain
                all ownership and rights to your content.
              </p>
              ...
              <p>
                ...
                including device information, IP address, browser type, referring pages, and pages
                visited. This data helps us improve our Service and understand user behavior
                patterns.
              </p>
              ...
              <p>
                When you make a document public and share it, we maintain metadata about the shared
                link including creation date, access count, and document title for analytics and
            ...
            <section>
              ...
              <ul className="ml-2 list-inside list-disc space-y-2">
                ...
                <li>
                  Monitoring and analyzing trends, usage, and activities for security and
                  functionality
                </li>
            ...
            <section>
              ...
              <p>
                We implement comprehensive technical, administrative, and physical safeguards to
                protect your personal information. However, no transmission over the Internet or
              ...
              <p>
                Your documents are encrypted in transit and at rest. Your password is hashed using
                industry-standard encryption. Access to personal information is restricted to
                employees who need it to provide services to you.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                active. If you delete your account, we will delete your personal information and
                documents within 30 days, except where we are required to retain data for legal or
                compliance purposes.
              </p>
              <p>
                Shared public documents may remain accessible via their unique links even if you
                delete your account, unless you explicitly revoke sharing before deletion.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Inkdown uses third-party service providers including Supabase for database services
                and analytics platforms. These providers have their own privacy policies and we
                encourage you to review them. We do not share personal information with third
                parties without your consent, except as necessary to provide the Service or as
                required by law.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                at any time by logging into your account or contacting us. You may also request a
                copy of your data or object to our processing of your information.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Inkdown is not intended for children under 13 years of age. We do not knowingly
